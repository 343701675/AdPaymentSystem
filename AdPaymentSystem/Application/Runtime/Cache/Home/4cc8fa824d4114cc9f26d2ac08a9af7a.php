...
<script type="text/javascript">
    ...
    <div class="col-md-12 text-title ft-em15 padding10">客户借贷方导入</div>
    <form class="well form-horizontal" id="fromlist" ms-controller="import" enctype="multipart/form-data" action="<?php echo U('Index/customdebit');?>" method="POST">
        <input type="hidden" name="import" value="导入" />
        <div class="form-group">
            <label class="col-sm-12"><span>导入说明:</span></label>
            <ol class="col-sm-12">
                <li>1.导入的数据必须是标准化数据，如：日期必须为标准日期格式</li>
                <li>2.导入的数据必须有列标题，如：年月，客户名称，本期借方；</li>
